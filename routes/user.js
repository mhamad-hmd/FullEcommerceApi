...
//Update
router.put("/:id", verifyToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
//get user
router.get("/find/:id", verifyToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                res.status(200).json(__assign({}, others));
                return [3 /*break*/, 3];
            case 2:
                err_3 = _b.sent();
