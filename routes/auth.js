...
//register
router.post("/register", jsonParser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newUser, savedUser, accessToken, others, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                others = __rest(savedUser._doc, []);
                res.status(200).json(__assign(__assign({}, others), { accessToken: accessToken }));
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
...
router.post("/login", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, hashedPassword, originalPassword, accessToken, _a, password, others, err_2;
